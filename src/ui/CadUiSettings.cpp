...
static void DrawSettingsDraftingTab(AppCommandState& cmd) {
  ...
  ImGui::Checkbox("Nearest (closest point on an edge)", &cmd.objectSnapNearest);
  ItemHelpTooltip("Snaps to the closest point on a line, polyline, arc, or feature line.");
  ImGui::Separator();
  ImGui::TextWrapped(
