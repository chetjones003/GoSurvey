...
enum class Problem {
  ...
  // --- REQ-329 CHAMFER: a flat bevel in place of a sharp edge (ADR-046 amendment (k)). The same
...
/// Bevel the edge \p edgeIndex of \p s by \p distance (REQ-329, ADR-046 amendment (k)). Writes the
