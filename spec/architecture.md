...
### ADR-058 — One clip plane with two aiming sources, and the plane's appearance is derived, not stored   (2026-09-11, accepted)

- **Status:** accepted (2026-09-11, D-2026-09-11-b, GitHub issue #479 slice 1). Backs REQ-338.
- **Context.** REQ-337 shipped a clip plane derived from the active UCS every frame. #479 asks for a
...
- **(c) The hatch and section line are DERIVED from the indicator rectangle every frame, not stored.**
  ...
  *This is what keeps the plane live.* REQ-337's whole claim is that moving the plane changes the
