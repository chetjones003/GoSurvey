...
- **Increment plan** (each its own branch, task and PR into `beta`):
  ...
  5. **MIRROR** — mirror line in the UCS plane.
...
- Acceptance:
  ...
  - **(increments 5-7)** MIRROR / ALIGN / OFFSET base points and reference
...
- Status: accepted — increments 1 (MOVE/COPY, TASK-218), 2 (ROTATE, TASK-219) and 3 (SCALE, TASK-220)
  delivered; increment 4 (STRETCH, TASK-221) in delivery (D-2026-09-08-b, GitHub issue #402).
  Increments 5-7 tracked in the issue.
