...
- **Increment plan** (each its own branch, task and PR into `beta`):
  ...
  4. **STRETCH** — crossing box and displacement in the view / UCS plane.
...
- Acceptance:
  ...
  - **(increment 3)** SCALE under a tilted UCS is uniform on every axis about the picked base point —
    ...
    within REQ-101;
  - **(increments 4-7)** STRETCH / MIRROR / ALIGN / OFFSET base points and reference
...
- Status: accepted — increments 1 (MOVE/COPY, TASK-218) and 2 (ROTATE, TASK-219) delivered;
  increment 3 (SCALE, TASK-220) in delivery (D-2026-09-08-b, GitHub issue #402). Increments 4-7
