...
- Acceptance, increment 2:
  ...
  - **A curved solid's wireframe carries isolines** (amended 2026-09-01, D-2026-09-01-g). The
    ...
    `ISOLINES` is; it is set by an `ISOLINES` command in the report-or-set shape, defaults to **8**
    ...
    cage; 8 doubles the meridian/latitude/ring line count while staying far under the REQ-100
