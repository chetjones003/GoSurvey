...
- Revisions: 2026-09-09 — initial. Kernel only: the sub-object grips that will call it, and the
  gizmo handles for an edge and a vertex that REQ-060 currently declines to draw, are their own
  slice and are deliberately not in this requirement.
