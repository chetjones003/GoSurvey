# TASK-223 — a blend's precondition sees the whole request (REQ-323 + REQ-331 item 4b)

## Requirement authority

- **REQ-323 item 4b** and **REQ-331 item 4b** — both AMENDED 2026-09-08 by **D-2026-09-08-g**.
...
the edge to the far boundary of each adjacent face"*, and REQ-331 item 4 said the same for a
...
- **testing** — PASS. `ctest` **1333/1333** (was 1325: +4 `FilletEdgeTests`, +4 `ChamferEdgeTests`),
  plus new blocks in both `headless.req323-fillet-solid` and `headless.req331-chamfer-solid`.
