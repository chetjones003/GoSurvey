# TASK-162 — REQ-309 selectable view projection (orthographic / perspective)
...
- **D-2026-08-31-g** — projection as a per-drawing view property; perspective made reachable.
...
| Public API / data format change? | **Yes** — two additive `.gs` fields, model viewport and named views. Escalated and settled by D-2026-08-31-g before implementation. |
...
- 2026-08-31 — Authority recorded (REQ-309, D-2026-08-31-g), plan written. Implementation starting.
...
- 2026-08-31 — Authority recorded (REQ-309, D-2026-08-31-g), plan written.
...
- **D-2026-08-31-h** — pure projection header; axis hues shared with the UCS icon.
...
| New dependency? | **No.** |
| Public API / data format change? | **Yes** — one additive `.gs` settings key. Settled by D-2026-08-31-h before implementation. |
