# TASK-168 — A prompted form for the seven solid primitives (issue #146, REQ-313 amended)

## Requirement authority

- **REQ-313** as amended — the increment-2 acceptance gains the prompted form.
- **D-2026-09-01-c** — the recorded decision, because this AMENDS an accepted requirement's stated
